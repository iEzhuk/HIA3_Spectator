...
private _d = HIA3_Spectator_LastFrameTime - _last_time;

if(_d < 0.3) then {
    private _curDir = HIA3_Spectator_AttachCam_Angle;
    private _newPos = HIA3_Spectator_AttachCam_Pos;
    ...
    private _wpos = (vehicle HIA3_Spectator_ViewUnit) modelToWorld _newPos;
    if (surfaceIsWater _wPos) then {
        private _tpos = ASLToATL _wPos;
